...
declare global {
  const A: typeof import('vue-termui')['TuiLink']
  ...
  const onInput: typeof import('vue-termui')['onInput']
  const onKeypress: typeof import('vue-termui')['onKeypress']
  const onMounted: typeof import('vue-termui')['onMounted']
  const onMouseEvent: typeof import('vue-termui')['onMouseEvent']
  ...
  const Text: typeof import('vue-termui')['TuiText']
  const TextTransform: typeof import('vue-termui')['TuiTextTransform']
  ...
  const TuiLink: typeof import('vue-termui')['TuiLink']
  const TuiNewline: typeof import('vue-termui')['TuiNewline']
  const TuiText: typeof import('vue-termui')['TuiText']
  const TuiTextTransform: typeof import('vue-termui')['TuiTextTransform']
