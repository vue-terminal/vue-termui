...
<template>
  <Box flexDirection="row" :gap="0">
    ...
    <Text :fg="PIP" :bg="FACE">{{ pips[vertical] }}</Text>

    <!-- tile boundary -->
    <Text :fg="edge" :bg="FACE">│</Text>

    <!-- horizontal domino following the vertical half -->
    <Text :fg="PIP" :bg="FACE">{{ pips[a] }}</Text>
    <Text :fg="edge" :bg="FACE">┆</Text>
    <Text :fg="PIP" :bg="FACE">{{ pips[b] }}</Text>
    <Text :fg="edge" :bg="BOARD">▏</Text>
  </Box>
</template>
